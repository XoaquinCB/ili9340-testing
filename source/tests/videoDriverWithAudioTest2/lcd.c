...
void initialiseLcd() {
    ...
    writeCommand(COMMAND_FRAME_CONTROL_IN_NORMAL_MODE, 2, (uint8_t[]) { 0x00, 0x1F }); // 61 Hz
    // writeCommand(COMMAND_FRAME_CONTROL_IN_NORMAL_MODE, 2, (uint8_t[]) { 0x00, 0x10 }); // 120 Hz
    // writeCommand(COMMAND_FRAME_CONTROL_IN_NORMAL_MODE, 2, (uint8_t[]) { 0x03, 0x1F }); // 8 Hz (doesn't work)
    // writeCommand(COMMAND_FRAME_CONTROL_IN_NORMAL_MODE, 2, (uint8_t[]) { 0x00, 0x15 }); // 90 Hz

    // writeCommand(COMMAND_DISPLAY_FUNCTION_CONTROL,     4, (uint8_t[]) { 0x0A, 0x82, 0x27, 0x00 }); // Interlaced scan
    writeCommand(COMMAND_DISPLAY_FUNCTION_CONTROL,     4, (uint8_t[]) { 0x02, 0x80, 0x27, 0x00 }); // Non-interlaced scan
    ...
    writeCommand(COMMAND_BLANKING_PORCH_CONTROL,       4, (uint8_t[]) {0x02, 0x2, 0x02, 0x02}); // VFP = 2, VBP = 127, HFP = 2, HBP = 2
